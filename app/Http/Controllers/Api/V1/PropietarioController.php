...
use App\Http\Requests\V1\StorePropietarioRequest;
use App\Http\Requests\V1\UpdatePropietarioRequest;
use App\Http\Resources\V1\PropietarioResource;
use App\Http\Resources\V1\PropietarioCollection;
